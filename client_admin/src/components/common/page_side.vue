	...
	<el-menu class="side el-menu-vertical-demo" default-active="/" @open="handleOpen" @close="handleClose"
		...
		<el-submenu index="user"
					v-show="user_group == '管理员' || $check_group(['/user/table','/user_group/table'
						,'/ministry_of_personnel/table'
							,'/finance_department/table'
							,'/sales_department/table'
							,'/procurement_department/table'
							,'/service_department/table'
																])">
			...
			<el-menu-item index="/user/table" v-show="user_group == '管理员'"><span>管理员</span></el-menu-item>
						<el-menu-item index="/ministry_of_personnel/table" v-show="user_group == '管理员' || $check_action('/ministry_of_personnel/table')"><span>人事部</span></el-menu-item>
							<el-menu-item index="/finance_department/table" v-show="user_group == '管理员' || $check_action('/finance_department/table')"><span>财务部</span></el-menu-item>
							<el-menu-item index="/sales_department/table" v-show="user_group == '管理员' || $check_action('/sales_department/table')"><span>销售部</span></el-menu-item>
							<el-menu-item index="/procurement_department/table" v-show="user_group == '管理员' || $check_action('/procurement_department/table')"><span>采购部</span></el-menu-item>
							<el-menu-item index="/service_department/table" v-show="user_group == '管理员' || $check_action('/service_department/table')"><span>服务部</span></el-menu-item>
				...
				for (var i = 0; i < tables.length; i++) {
					...
					if (o.path.indexOf("/table") !== -1) {
						let list = ["exam","article", "article_type", ,"comment","notice"];
							list.push("ministry_of_personnel");
								list.push("finance_department");
								list.push("sales_department");
								list.push("procurement_department");
								list.push("service_department");
