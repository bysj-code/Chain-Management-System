		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','product_type')" min-width="200">
					...
					<el-table-column prop="storage_location" @sort-change="$sortChange" label="存放位置"
				v-if="user_group == '管理员' || $check_field('get','storage_location')" min-width="200">
					</el-table-column>
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/product_information/table','set') || $check_action('/product_information/view','set') || $check_action('/product_information/view','get') || $check_action('/采购|销售|入库|出库/table','add') || $check_action('/采购|销售|入库|出库/view','add')" >
				...
				<template slot-scope="scope">
					...
					v-if="user_group == '管理员' || $check_action('/product_information/table','set') || $check_action('/product_information/view','set') || $check_action('/product_information/view','get')"
						...
						<!--跨表按钮-->
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/procurement_information/view')" v-if="user_group == '管理员' || $check_action('/procurement_information/table','add') || $check_action('/procurement_information/view','add')">
						<span>采购</span>
					</el-button>
							<el-button class="el-button el-button--small is-plain el-button--default" style="margin: 5px !important;" size="small" @click="to_table(scope.row,'/sales_information/view')" v-if="user_group == '管理员' || $check_action('/sales_information/table','add') || $check_action('/sales_information/view','add')">
						<span>销售</span>
					</el-button>
