		...
		<el-form label-position="right" :model="query" class="form p_4" label-width="120">
			<el-row>
					...
					<el-form-item label="出库人员">
									<el-input v-model="query.outbound_personnel"></el-input>
								</el-form-item>
				</el-col>
					...
					<el-form-item>
						...
						<router-link v-if="user_group == '管理员' || $check_action('/outbound_information/table','add') || $check_action('/outbound_information/view','add')" class="el-button el-button--default el-button--primary search_btn_add" to="./view?">添加
						</router-link>
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			<el-table-column fixed type="selection" tooltip-effect="dark" width="55">
				...
				v-if="user_group == '管理员' || $check_field('get','product_name')" min-width="200">
					...
					<el-table-column prop="outbound_personnel" @sort-change="$sortChange" label="出库人员"
				v-if="user_group == '管理员' || $check_field('get','outbound_personnel')" min-width="200">
					</el-table-column>
					<el-table-column prop="delivery_time" @sort-change="$sortChange" label="出库时间"
			...
			<el-table-column fixed="right" label="操作" min-width="120" v-if="user_group == '管理员' || $check_action('/outbound_information/table','set') || $check_action('/outbound_information/view','set') || $check_action('/outbound_information/view','get') || $check_action('//table','add') || $check_action('//view','add')" >
