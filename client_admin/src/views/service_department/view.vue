		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			...
			<el-col :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				...
				<el-form-item label="员工工号" prop="employee_id">
							  ...
							  v-if="user_group === '管理员' || (form_sub['service_department_id'] && $check_field('set','employee_id')) || (!form_sub['service_department_id'] && $check_field('add','employee_id'))"></el-input>
				...
				<el-form-item label="员工姓名" prop="employee_name">
							  ...
							  v-if="user_group === '管理员' || (form_sub['service_department_id'] && $check_field('set','employee_name')) || (!form_sub['service_department_id'] && $check_field('add','employee_name'))"></el-input>
				...
				<el-form-item label="员工性别" prop="employee_gender">
						...
						v-if="user_group === '管理员' || (form_sub['service_department_id'] && $check_field('set','employee_gender')) || (!form_sub['service_department_id'] && $check_field('add','employee_gender'))">
