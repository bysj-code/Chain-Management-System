<template>
  <view class="page_ministry_of_personnel diy_table diy_table_tml" id="ministry_of_personnel_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/ministry_of_personnel/view?" v-show="user_group == '管理员' || $check_action('/ministry_of_personnel/table','add') || $check_action('/ministry_of_personnel/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/ministry_of_personnel/table','del') || $check_action('/ministry_of_personnel/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/ministry_of_personnel/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/ministry_of_personnel/table','set') || $check_action('/ministry_of_personnel/view','set') || $check_action('/ministry_of_personnel/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/ministry_of_personnel/get_list?like=0",
				url_del: "~/api/ministry_of_personnel/del?",
