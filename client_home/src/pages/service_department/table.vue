<template>
  <view class="page_service_department diy_table diy_table_tml" id="service_department_table">
    <!-- 筛选模块(开始) -->
    <view>
        ...
        <view>
          <view>
            <view class="table_padding_top">
              <navigator class="nav_left" url="/pages/service_department/view?" v-show="user_group == '管理员' || $check_action('/service_department/table','add') || $check_action('/service_department/view','add')">添加</navigator>
                  ...
                  <view class="col">
                    <view class="view">
                      <view class="create_time_block diy_filed diy_time">
                        ...
                        <button class="delete_a_btn" @click="delInfo(i)" v-show="user_group == '管理员' || $check_action('/service_department/table','del') || $check_action('/service_department/view','del')">删除</button>
                      </view>
                    </view>
                  </view>
					<view class="uni-padding-wrap uni-common-mt">
					<navigator  :url="'/pages/service_department/view?' + field + '=' + o[field]"
                               v-show="user_group == '管理员' || $check_action('/service_department/table','set') || $check_action('/service_department/view','set') || $check_action('/service_department/view','get')" class="btn btn-primary">详情</navigator>
	        					</view>
				</view>
			</view>
		</view>
...
<script>
	...
	export default {
		...
		data() {
			return {
				// 获取数据地址
				url_get_list: "~/api/service_department/get_list?like=0",
				url_del: "~/api/service_department/del?",
