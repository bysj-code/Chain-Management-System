<template>
	<view class="page_product_information diy_list diy_list_page div_list_tml" id="product_information_list">
		<!-- 筛选模块(开始) -->
		<view>
			<view class="container">
				<view>
					<view>
						<view class="">
							<!-- 搜索栏 -->
													<uni-search-bar placeholder="搜索商品编号" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'product_number')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索商品名称" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'product_name')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																			<uni-search-bar placeholder="搜索商品类型" @confirm="search" @cancel="cancel" cancelText="取消"
											@input="input($event, 'product_type')">
								<uni-icons slot="searchIcon" color="#999999" size="18" type="home" />
							</uni-search-bar>
																	<!-- /搜索栏 -->
						</view>
			...
			<view class="container">
				<view v-for="(o,i) in list" class="row">
					...
					<view class="uni-padding-wrap uni-common-mt">
						<navigator class="btn btn-primary" :url="'./details?product_information_id=' + o['product_information_id']">查看详情</navigator>
					</view>
				</view>
			</view>
		</view>
