<template>
	<view class="diy_details diy_div_procurement_information">
		<view v-if="Object.keys(obj).length!==0" class="warp">
			<view class="container">
				<view class="row">
					...
					<view v-if="$check_field('get','supplier')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>供应商:</span>
						</view>
							<view class="diy_field diy_text">
					...
					<view v-if="$check_field('get','procurement_personnel')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>采购人员:</span>
						</view>
							<view class="diy_field diy_text">
							<text>
								{{obj["procurement_personnel"]}}
							</text>
						</view>
						</view>
					...
					<view v-if="$check_field('get','purchase_price')" class="col-12 col-md-6">
						<view class="diy_title">
							<span>采购价格:</span>
						</view>
							<view class="diy_field diy_text">
...
<script>
	...
	export default {
		...
		methods: {
			...
			async get_obj_by_id(){
				var res = await this.$get("~/api/procurement_information/get_obj", {
					procurement_information_id:this.query.procurement_information_id
				})
		...
		async onLoad(){
			...
			} else if (this.query["procurement_information_id"] !==0) {
...
<style scoped>
	.div_procurement_information_details {}
